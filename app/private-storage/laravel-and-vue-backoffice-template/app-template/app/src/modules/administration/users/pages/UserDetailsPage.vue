    ...
    <template #content>
      ...
      <q-card-section>
        ...
        <q-card-actions align="right">
          <q-btn
            flat
            label="Pošalji aktivacioni e-mail"
            icon="send"
            color="blue-5"
          ...
          <q-btn
            flat
            :label="accountStateButton.label"
            :icon="accountStateButton.icon"
            :color="accountStateButton.color"
            @click="setAccountState"
          >
...
import type { UserData } from '../components/UserForm.vue'
...
const accountStateButton = computed(function () {
  return userStore.getUserDetails?.is_active
    ? {
        ...
        icon: 'highlight_off',
        tooltip:
          'Ova akcija deaktivira korisnički nalog i korisnik više neće imati pravo pristupa sistemu!',
      }
    : {
        ...
        tooltip:
          'Ova akcija aktivira korisnički nalog i korisnik će ponovo imati pravo pristupa sistemu!',
      }
})
