...
export const petUpdateRequestSchema = Type.Object(
    {
...
export type PetUpdateRequestSchemaType = Static<typeof petUpdateRequestSchema>


export const petUpdateResponseSchema = Type.Object(
    {
        message: Type.String(),
...
export type PetUpdateResponseSchemaType = Static<typeof petUpdateResponseSchema>


export const petUpdateParamSchema = Type.Object({
        id: Type.Number({errorMessage: 'Pet ID must be a number'})
    },
    {
        errorMessage: {
            type: 'Invalid JSON',
